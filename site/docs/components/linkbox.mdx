...
<Playground>
  ...
  <div style={{ maxWidth: '384px' }}>
    <Linkbox
      ...
      heading="Linkbox title"
      text="Linkbox text"
      imgProps={{ src: "https://hds.hel.fi/v1/static/assets/placeholders/image/image-m@3x.png", width: 384, height: 245 }}
    />
  </div>
  </div>
</Playground>
...
<Playground>
  ...
  <div style={{ maxWidth: '284px' }}>
    <Linkbox
      ...
      text="Linkbox text"
      imgProps={{ src: "https://hds.hel.fi/v1/static/assets/placeholders/image/image-s@3x.png", width: 284, height: 181 }}
      size="small"
      withBorder
    />
  </div>
  <div style={{ maxWidth: '384px', marginTop: 'var(--spacing-s)' }}>
    <Linkbox
      ...
      text="Linkbox text"
      imgProps={{ src: "https://hds.hel.fi/v1/static/assets/placeholders/image/image-s@3x.png", width: 384, height: 245 }}
      withBorder
    />
  </div>
  <div style={{ maxWidth: '567px', marginTop: 'var(--spacing-s)' }}>
    <Linkbox
      ...
      text="Linkbox text"
      imgProps={{ src: "https://hds.hel.fi/v1/static/assets/placeholders/image/image-l@3x.png", width: 567, height: 363 }}
      withBorder
      size="large"
    />
  </div>

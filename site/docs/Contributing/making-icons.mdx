...
<Image src="https://hds.hel.fi/v1/static/assets/image/icontypes@2x.jpg" alt="A selection of icons for different uses in HDS" style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/basicshapes@2x.jpg" alt="Basic shapes are the best starting point for icon creation" style="max-width:600px;" viewable />
...
## Dimensions
<Image src="https://hds.hel.fi/v1/static/assets/image/dimensions@2x.jpg" alt="The icon size variants used by HDS" style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/keyshapes_orthogonals@2x.jpg" alt="Left: Keyshapes. Right: Orthogonals. The building blocks of an effective icon grid." style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/masking@2x.jpg" alt="Basic steps to masking" style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/pixelgrid@2x.jpg" alt="A simple pixel grid for making icons." style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/icongrid@2x.jpg" alt="A simple icon grid for making icons." style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/safearea_trimarea@2x.jpg" alt="The difference between safe area and trim area explained." style="max-width:600px;" viewable />
...
<Image src="https://hds.hel.fi/v1/static/assets/image/AlertCircle_Fill_cropped.gif" alt="How to make the Alert Circle icon using basic shapes." style="max-width:600px;" viewable />

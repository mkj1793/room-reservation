...
<Image src="https://hds.hel.fi/v1/static/start-design.svg" alt="Getting started for designers" style={{maxWidth: 'var(--spacing-layout-xl)', marginBottom: 'var(--spacing-layout-xs)'}}/>
...
<Image src="https://hds.hel.fi/v1/static/fordesigners-component-overrides.png" alt="Customising symbol overrides" style="width: 100%; max-width:850px; margin-bottom:24px;" viewable/>
...
<Image src="https://hds.hel.fi/v1/static/fordesigners-typography-header-insert.png" alt="Inserting header styles" style="width: 100%; max-width:850px; margin-bottom:24px;" viewable/>
...
<Image src="https://hds.hel.fi/v1/static/fordesigners-typography-textstyle-appearance.png" alt="Changing text elements style" style="width: 100%; width: 100%; max-width:850px; margin-bottom:24px;" viewable/>

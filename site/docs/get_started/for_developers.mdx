...
<Image src="https://hds.hel.fi/v1/static/start-develop.svg" alt="Getting started for designers"  style={{maxWidth: 'var(--spacing-layout-xl)', marginBottom: 'var(--spacing-layout-xs)'}}/>
